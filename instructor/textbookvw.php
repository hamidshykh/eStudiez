...
<div class="container">
    ...
    <div class="Admin-Content">
        <h3>My All TextBooks</h3>
    </div>

    <div class="Add-admin">
            <a href="uploadtextbook.php" class="btn btn-success">Upload Class Video</a>
    </div>
  ...
  <?php
      ...
      //GET QUERY THE ADMIN
      $sql = "SELECT * FROM `textbook` WHERE `TeacherID` = '$_SESSION[ID]'";
      ...
      <tr>
        ...
        <td>            
            <a href="deletepdf.php?ID=<?php echo $rows['ID'];?>" class="btn btn-danger">Delete</a>
        </td>
      </tr>
