...
include('../config/instructorlogincheck.php');
?>
...
<header class="page-header">
  <nav>   
    ...
    <ul class="admin-menu">
      ...
      <a href="../instructor/myprofile.php">
          <svg>
            <use xlink:href="#charts"></use>
          </svg>
          <span> My Profile</span>
        </a>      
        <a href="../instructor/mystudent.php">
          <svg>
            <use xlink:href="#collection"></use>
          </svg>
          <span>My Student</span>
        </a>
        <a href="../instructor/indexvideo.php">
          <svg>
          <use xlink:href="#users"></use>
          </svg>
          <span>Upload Video</span>
        </a> 
        <a href="../instructor/textbookvw.php">
          <svg>
            <use xlink:href="#settings"></use>
          </svg>
          <span>Add textBook</span>
        </a>
        <a href="../instructor/links.php">
          <svg>
            <use xlink:href="#collection"></use>
          </svg>
          <span>Video Link</span>
        </a>               
        <a href="../instructor/contactadmin.php">
          <svg>
            <use xlink:href="#settings"></use>
          </svg>
          <span>Contact Admin</span>
        </a>        
        <a href="indexmarks.php">
          <svg>
            <use xlink:href="#settings"></use>
          </svg>
          <span>Add Progress</span>
        </a>
        <a href="inyermarks.php">
          <svg>
            <use xlink:href="#charts"></use>
          </svg>
          <span>Add Result</span>
        </a>
        <a href="../instructor/managetimeindex.php">
          <svg>
            <use xlink:href="#collection"></use>
          </svg>
          <span>Extra Classes</span>
        </a>
        <a href="../instructor/dropacademy.php">
          <svg>
          <use xlink:href="#users"></use>
          </svg>
          <span>Drop Academy</span>
        </a>                
      </li>      
      <li>
          <div class="switch">
...
<div class="d-flex align-items-center py-3 justify-content-end gradient">
  ...
  <div class="sitename">
      <h4 style="position: absolute; left: 48px; top: 44px; font-family: 'poppis';">Dashboard</h4>
  </div>
